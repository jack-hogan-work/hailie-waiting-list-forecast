...
def main():
    ...
    ax.fill_between(fy, [float(r["lower_95"]) for r in national], [float(r["upper_95"]) for r in national], color="#dfeeee", label="95% range")
    ...
    ax.legend(frameon=False, ncol=4, loc="lower left", bbox_to_anchor=(0, -0.28), fontsize=9)
    ...
    f2028 = {r["region"]: float(r["point_forecast"]) for r in regional if r["forecast_year"] == "2028"}
    ...
    ax.legend(frameon=False, ncol=2, loc="lower left", bbox_to_anchor=(0, -0.17), fontsize=9)
